...
public class P9WebView extends AppCompatActivity {
    WebView mwebview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_p9_web_view);
...
/*JavaScript is by default turned off in WebView widgets. Hence
 web pages containing javascript references won’t work properly.*/
        ...
        mwebview.setWebViewClient(new MyWebViewClient());  //to fetch WebViewClient classmwebview.setWebChromeClient(new MyWebCromeClient());
    }
...
any history found through the options of menu.*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.p9mymenu, menu);
        return true;
    }
    @Override
